...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val buttonMS: Button = findViewById(R.id.buttonMS) as Button
        buttonMS.setOnClickListener {
            savedVal = operationVal
        }

        val buttonMR: Button = findViewById(R.id.buttonMR) as Button
        buttonMR.setOnClickListener {
            operationVal = savedVal
            setValues()
        }

        val buttonMC: Button = findViewById(R.id.buttonMC) as Button
        buttonMC.setOnClickListener {
            savedVal = "0"
        }

        val buttonDel: Button = findViewById(R.id.buttonDel) as Button
        ...
        val buttonSum: Button = findViewById(R.id.buttonSum) as Button
        ...
        val buttonSub: Button = findViewById(R.id.buttonSub) as Button
        ...
        val buttonMult: Button = findViewById(R.id.buttonMult) as Button
        ...
        val buttonDiv: Button = findViewById(R.id.buttonDiv) as Button
        ...
        val buttonRes: Button = findViewById(R.id.buttonResult) as Button
        ...
        val buttonComma: Button = findViewById(R.id.buttonComma)
